            ...
            return (
                <div>
                    ...
                    <div className="mb-3">
                        ...
                        className="form-label">Pavardė <span className="fieldRequired">*</span></label>
                        <input
                            type="text"
                            id="txtSurname"
                            name="surname"
                ...
                <div className="form">
                    <form onSubmit={this.handleUpdatePasswordSubmit}>
                        ...
                        <div className=" form-group py-2">
                            ...
                            <p className="text-primary my-0">Dėmesio! Slaptažodis turi būti 8-255 simbolių ilgio, turėti bent vieną didžiąją ir mažąją raides ir bent vieną skaičių.</p>
                            <input
                                type="password"
                                id="txtNewPassword"
                                name="newPassword"
                        ...
                        <div className=" form-group pt-2">
                            <button type="submit" className="btn btn-primary" id="btnUpdateProfile">Išsaugoti</button>
                        </div>
                    </form>
                </div>
            )
