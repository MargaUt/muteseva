...
export class QueueContainer extends Component {
    ...
    getApplications(currentPage, personalCode) {
        ...
        if (isActive) {
            ...
            if (personalCode !== "") {
                const encodedSearch = encodeURIComponent(personalCode);
                uri = `${apiEndpoint}/api/prasymai/manager?page=${page}&size=${pageSize}&search=${encodedSearch}`;
            ...
            if (personalCode !== "") {
                const encodedSearch = encodeURIComponent(personalCode);
                uri = `${apiEndpoint}/api/eile/manager/queue?page=${page}&size=${pageSize}&search=${encodedSearch}`;
