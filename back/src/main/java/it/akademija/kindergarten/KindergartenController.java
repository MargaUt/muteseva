...
public class KindergartenController {
	...
	public ResponseEntity<String> createNewKindergarten(
		...
		if (kindergartenService.findById(id) != null) {
			...
			return new ResponseEntity<>("Darželis su tokiu įstaigos kodu jau yra", HttpStatus.CONFLICT);
			...
			return new ResponseEntity<>("Darželis sukurtas sėkmingai", HttpStatus.OK);
		}
	...
	public ResponseEntity<String> updateKindergarten(
		...
		if (kindergartenService.findById(id) == null) {
			...
			return new ResponseEntity<>("Darželio duomenys atnaujinti sėkmingai", HttpStatus.OK);
		}
