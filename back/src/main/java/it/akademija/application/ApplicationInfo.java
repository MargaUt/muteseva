...
public class ApplicationInfo {
	...
	public ApplicationInfo(Long id, String childPersonalCode, String childName, String childSurname,
			ApplicationStatus status, String choise1, String choise2, String choise3, String choise4, String choise5) {
		super();
		this.id = id;
